    ...
    <div className="grid gap-3">
      {sources.map((s, i) => (
        <button
          ...
          className="flex items-center gap-4 p-4 rounded-lg border border-border hover:bg-accent hover:border-foreground/20 active:scale-[0.98] text-left transition-[background-color,border-color,transform] duration-200 ease-out"
