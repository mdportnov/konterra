...
const PILLARS = [
  {
    ...
    description:
      'Visualize your entire network on an interactive 3D globe. Every contact, connection, and country — plotted, searchable, and explorable. Turn scattered contacts into a living topology of your social capital.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Relationship scoring, interaction tracking, and decay alerts ensure you nurture the connections that matter — before they fade. Understand who your strongest allies are, and where your network is thinning.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-6">
        <path d="M3 3v18h18" />
  ...
  {
    title: 'Mobilize',
    subtitle: 'Activate your network',
    description:
      'When opportunity strikes, find the warmest path to any person through your existing connections. Track favors, introductions, and reciprocity — the currency of trust that no algorithm can replicate.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-6">
...
const FEATURES = [
  ...
  { title: 'Relationship Intelligence', description: 'Automated scoring based on interaction recency and depth' },
  { title: 'Connection Insights', description: 'Discover clusters, bridges, and gaps in your network' },
  { title: 'Favor & Reciprocity Tracking', description: 'Monitor the balance of social capital exchange' },
  { title: 'Travel Integration', description: 'Overlay your trips with your contact map for serendipity' },
