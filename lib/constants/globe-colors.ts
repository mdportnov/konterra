...
export const POLYGON_COLORS = {
  ...
  wishlist: { dark: 'rgba(244, 114, 182, 0.18)', light: 'rgba(236, 72, 153, 0.14)' },
  wishlistStroke: { dark: 'rgba(244, 114, 182, 0.5)', light: 'rgba(236, 72, 153, 0.4)' },
  wishlistVisited: { dark: 'rgba(244, 114, 182, 0.32)', light: 'rgba(236, 72, 153, 0.22)' },
  wishlistVisitedStroke: { dark: 'rgba(244, 114, 182, 0.7)', light: 'rgba(236, 72, 153, 0.55)' },
