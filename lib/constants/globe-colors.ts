...
export const POLYGON_COLORS = {
  ...
  wishlist: { dark: 'rgba(250, 204, 21, 0.18)', light: 'rgba(234, 179, 8, 0.14)' },
  wishlistStroke: { dark: 'rgba(250, 204, 21, 0.45)', light: 'rgba(234, 179, 8, 0.35)' },
  wishlistVisited: { dark: 'rgba(250, 204, 21, 0.32)', light: 'rgba(234, 179, 8, 0.22)' },
  wishlistVisitedStroke: { dark: 'rgba(250, 204, 21, 0.65)', light: 'rgba(234, 179, 8, 0.5)' },
