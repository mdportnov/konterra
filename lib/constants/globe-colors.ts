...
export const POLYGON_COLORS = {
  ...
  wishlist: { dark: 'rgba(251, 146, 60, 0.18)', light: 'rgba(249, 115, 22, 0.14)' },
  wishlistStroke: { dark: 'rgba(251, 146, 60, 0.5)', light: 'rgba(249, 115, 22, 0.4)' },
  wishlistVisited: { dark: 'rgba(251, 146, 60, 0.32)', light: 'rgba(249, 115, 22, 0.22)' },
  wishlistVisitedStroke: { dark: 'rgba(251, 146, 60, 0.7)', light: 'rgba(249, 115, 22, 0.55)' },
