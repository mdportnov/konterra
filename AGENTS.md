...
Agent instructions for the `konterra` repository.
...
- `.agents/prd-context-menu.md` — PRD for the right-click context menu feature. Read on demand before touching context-menu UI.
- `.agents/skills/neon-postgres/SKILL.md` — Claude Code skill bundle for Neon Postgres; lazy-loaded by Claude on relevant tasks.
